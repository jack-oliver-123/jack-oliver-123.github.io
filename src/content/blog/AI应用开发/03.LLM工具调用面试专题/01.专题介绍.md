---
title: "LLM工具调用面试题介绍"
description: "LLM工具调用面试题介绍 做 AI 应用，光让大模型能聊天是远远不够的，你得让它能「干活」，能查数据库、能调 API、能操作文件，这些能力的背后就是工具调用。Function Calling、MCP、A2A 这些概念现在面试里问得越来越多，但我发现很多同学对它们的理解还停留在「都是调工具的」这个层面，一追问就分不清谁是"
tags: ["AI应用开发", "LLM工具调用"]
draft: false
featured: false
---
...
> 原文来源：[小林面试笔记](https://xiaolinnote.com/ai/tools/tools_info.html)
