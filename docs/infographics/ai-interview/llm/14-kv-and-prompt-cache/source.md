...
description: "区分单次解码 KV Cache 与跨请求 Prompt/Prefix Cache，并说明容量公式、命中条件和隔离风险"
tags: ["AI应用开发", "大模型工程"]
draft: false
featured: false
---
...
- [Hugging Face caching documentation](https://huggingface.co/docs/transformers/main/en/cache_explanation)
