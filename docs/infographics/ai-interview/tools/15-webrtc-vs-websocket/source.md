...
description: "分析 WebRTC 与 WebSocket 在 AI 对话流中的差异，梳理低延迟音视频、点对点连接和实时交互场景的协议选择"
tags: ["AI应用开发", "LLM工具调用"]
draft: false
featured: false
---
...
- [RFC 8834：WebRTC Media Transport and Use of RTP](https://www.rfc-editor.org/rfc/rfc8834)
