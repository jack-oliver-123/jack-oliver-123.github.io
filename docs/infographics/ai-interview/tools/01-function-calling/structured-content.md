...
系统介绍 Function Calling 的原理和调用流程，梳理模型如何生成结构化参数并由外部系统完成工具执行

## Learning Objectives

The viewer will understand:

1. 说明“什么是 Function Calling？原理是什么？”的组成部分及其关系
...
### 结构正确不等于业务正确
Schema 能约束类型、必填字段和枚举，但无法判断“把 10 万元转给这个收款人”是否符合权限与业务规则。
