...
下图展示了双向链表的节点结构——每个节点包含 prev、data、next 三个部分：

![双向链表结构：prev/data/next 三格节点通过双向箭头连接](/images/data-structures/linkedlist-structure.svg)
...
下图以双向链表为例，展示了在 A 和 B 之间插入新节点 X 时的指针修改顺序：

![链表插入操作：4 步指针修改完成节点插入](/images/data-structures/linkedlist-insert.svg)
