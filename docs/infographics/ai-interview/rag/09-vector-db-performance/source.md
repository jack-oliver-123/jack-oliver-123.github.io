...
description: "介绍向量数据库在实际 RAG 项目中的数据规模、性能瓶颈和优化方法，梳理索引、召回和延迟的平衡"
tags: ["AI应用开发", "RAG"]
draft: false
featured: false
---
...
- [Milvus: Benchmark a Milvus deployment](https://milvus.io/docs/benchmark.md)
- [Qdrant: Benchmarking](https://qdrant.tech/benchmarks/)
