...
description: "基于硬件、模型支持、吞吐、结构化生成和运维状态比较 vLLM、SGLang、TGI 与 llama.cpp"
tags: ["AI应用开发", "大模型工程"]
draft: false
featured: false
---
...
- [SGLang project and documentation](https://github.com/sgl-project/sglang)
- [llama.cpp project](https://github.com/ggml-org/llama.cpp)
- [Text Generation Inference maintenance notice](https://github.com/huggingface/text-generation-inference)
